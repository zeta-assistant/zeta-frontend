...
export default function SignupPage() {
  ...
  const handleSignup = async () => {
    ...
    setSent(true); // email verification required if enabled in Supabase
  };
    ...
    try {
      await fetch('/api/auth/resend', {
        ...
        headers: {
          ...
          // Optional header gate if you set RESEND_KEY server-side and expose NEXT_PUBLIC_RESEND_KEY
